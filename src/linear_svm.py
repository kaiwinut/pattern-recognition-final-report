...
""" Training
	...
	- Get best k value
"""
model = LinearSVM(lam = 0.1, n_iters = 100, lr = 1e-2)
...
# plot_prediction(test_df, model, evaluation, 'Heart Disease Prediction w/ Linear SVM', os.path.join(path, 'linear_svm.png'))
plot_prediction(test_df, model, evaluation, 'Heart Disease Prediction w/ Linear SVM', os.path.join(path, 'linear_svm_st.png'), 'Age', 'ST_Slope_Flat')