...
# plot_prediction(test_df, model, evaluation, 'Heart Disease Prediction w/ Linear SVM', os.path.join(path, 'linear_svm_sklearn_st.png'), 'Age', 'ST_Slope_Flat')
plot_prediction(test_df, model, evaluation, 'Heart Disease Prediction w/ RBF SVM', os.path.join(path, 'rbf_svm_sklearn_st.png'), 'Age', 'ST_Slope_Flat')
# plot_prediction(test_df, model, evaluation, 'Heart Disease Prediction w/ RBF SVM', os.path.join(path, 'rbf_svm_sklearn.png'))